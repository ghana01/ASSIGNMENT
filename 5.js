// You are building a shipping application. Write a program that takes the type of package ("standard", "express", or "overnight") 
// and uses a switch statement to calculate and print the estimated delivery time based on the package type. 
